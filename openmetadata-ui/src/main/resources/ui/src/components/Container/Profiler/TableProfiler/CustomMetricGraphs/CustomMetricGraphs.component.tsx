...
import {
  deleteContainerCustomMetric,
  putContainerCustomMetric,
...
import ContainerCustomMetricForm from '../../../../DataQuality/CustomMetricForm/ContainerCustomMetricForm.component';
...
const CustomMetricGraphs = ({
  ...
  const handleDeleteClick = async () => {
    if (containerDetails && selectedMetrics) {
      setIsActionLoading(true);
      try {
        const { data } = await deleteContainerCustomMetric({
  ...
  const handleEditFormSubmit = async (values: CustomMetric) => {
    if (containerDetails) {
      ...
      try {
        const { data } = await putContainerCustomMetric(
          containerDetails.id,
          updatedMetric
        );
        showSuccessToast(
