...
import { getColumnProfilerList } from '../../../../rest/containerAPI';
import {
  calculateColumnProfilerMetrics,
  calculateCustomMetrics,
  getContainerColumnCustomMetric,
...
const SingleColumnProfile: FC<SingleColumnProfileProps> = ({
  ...
  const customMetrics = useMemo(
    () =>
      getContainerColumnCustomMetric(
        containerDetails ?? tableCustomMetric,
        activeColumnFqn
      ) ?? [],
    [tableCustomMetric, activeColumnFqn, containerDetails]
  );
